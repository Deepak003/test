...
const ModalContents: ComponentProps<typeof WithModal>['modal'] = ({ onClose }) => (
  <div style={{ background: 'papayawhip', fontSize: '12px' }}>
    ...
    nibh. Nulla eu lobaliquamortis ante. Vivamus tortor sapien, dictum sit amet lacus sit amet,
    cursus porttitor sapien. Donec a massa et felis dictum eleifend. Etiam in dui at magna imperdiet
    gravida. Nam id tortor in leo facilisis elementum sit amet accumsan nunc. Maecenas lacus metus,
    dapibus mauris ac, luctus gravida ex.Lorem ipsum dolor sit amet, consectetur adipiscing elit.
    Praesent egestas, ante eu ornare tincidunt, justo velit ultrices est, eu porta libero ante
